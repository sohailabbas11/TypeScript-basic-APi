...
const ExampleSchema_1 = __importDefault(require("../model/ExampleSchema"));
...
const getExampleData = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const example = yield ExampleSchema_1.default.findOne({ name });
        if (example)
            return next((0, http_errors_1.default)(406, "example already exists"));
        const newExample = new ExampleSchema_1.default({ name, id });
